...
{
    class CAndruavCommServerLocal : public std::enable_shared_from_this<CAndruavCommServerLocal>, public CCallBack_WSASession, public CAndruavCommServerBase
    {
    public:
    ...
    private:
        CAndruavCommServerLocal() : CAndruavCommServerBase() // Call the base class constructor
        {
        }
    ...
    public:
        ~CAndruavCommServerLocal() override = default;

    public:
        void start() override;
        void start(const std::string comm_server_ip, const uint16_t comm_server_port, const std::string comm_server_key) override;
    ...
    public:
        // Class Methods - Not Inherited from CAndruavCommServerBase
        void reconnectToCommServer(const std::string server_ip, const std::string server_port, const std::string key);
    ...
    public:
        ...
        bool isLocalCommServer() const
        {
            return m_is_local_comm_server;
        }
        void isLocalCommServer(const bool is_local)
        {
            m_is_local_comm_server = is_local;
        }
